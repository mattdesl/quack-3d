 ...
 *	08.01.05		1.2		Mr.doob			+ Click changes the _fps of flash (half up increases, half down decreases)
...
package net.hires.debug
{
	...
	{	
		...
		private function init(e : Event) : void
		{
			...
			xml = <xml><_fps>FPS:</_fps><ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax></xml>;
		
			style = new StyleSheet();
			style.setStyle("xml", {fontSize:'9px', fontFamily:'_sans', leading:'-2px'});
			style.setStyle("_fps", {color: '#FFFF00'});
		...
		private function update(e : Event) : void
		{
			...
			if( timer - 1000 > ms_prev )
			{
				...
				fps_graph = Math.min( 50, ( _fps / stage.frameRate ) * 50 );
				...
				xml._fps = "FPS: " + _fps + " / " + stage.frameRate;
				realFPS = _fps;
				xml.mem = "MEM: " + mem;
